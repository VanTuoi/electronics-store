        ...
        <div className="p-4 rounded-3">
            ...
            <section className="mb-4">
                ...
                <p className="text-muted">
                    Chúng tôi cam kết bảo vệ thông tin cá nhân của khách hàng bằng các biện pháp bảo mật phù hợp và
            ...
            <section>
                ...
                <p className="text-muted">
                    Nếu bạn có bất kỳ câu hỏi nào về chính sách bảo mật của chúng tôi, vui lòng liên hệ qua email hoặc
                    số điện thoại được cung cấp trong phần liên hệ.
                </p>
            </section>
        </div>
    </div>
