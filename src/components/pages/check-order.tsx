            ...
            <div className="card-body">
              <form onSubmit={handleSearch} className="mb-4">
                <div className="input-group shadow rounded-pill overflow-hidden">
                  ...
                  />
                  <button className="btn btn-primary px-4 text-nowrap" type="submit" disabled={loading}>
                    {loading ? (
                      <>
                      ...
                      <tbody>
                        {order.products.map(product => (
                          <tr key={product.id}>
                            ...
                            <td className="text-center">{formatCurrency(product.price.toFixed(2))}</td>
                            <td className="text-center">{product.quantity}</td>
                            <td className="text-end">
                              {formatCurrency((product.price * product.quantity).toFixed(2))}
                            </td>
                          </tr>
                        ))}
                      </tbody>
