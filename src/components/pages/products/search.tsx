                  ...
                  <li key={idx}>
                    <button
                      className={`dropdown-item ${
                        selectedPriceRange.min === range.min && selectedPriceRange.max === range.max ? "active" : ""
                      }`}
                      onClick={() =>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (typeof filter === "string" && filter.includes("-")) {
                            ...
                            setSelectedCategories(prev =>
                              prev.filter(id => id !== categories?.find(c => c.name === filter)?.id)
                            );
                          } else {
                            setSelectedSort("");
                          }
        ...
        <div className="row justify-content-center mt-3">
          <div className="col-md-8">
            <div className="custom-input-group">
              ...
              />
              <button className="custom-button bg-secondary" type="button" onClick={handleSearch} disabled={loading}>
