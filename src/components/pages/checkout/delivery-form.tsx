  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="row g-3">
      ...
      <div className="col-12 text-muted fst-italic">
        - Để đảm bảo an toàn và chính xác nhân viên kinh doanh sẽ liên hệ lại Quý Khách hàng để xác nhân đơn hàng với số
        điện thoại đặt lần đầu.
      </div>
      <div className="col-12 text-muted fst-italic">
        - Thông tin cá nhân của bạn sẽ được sử dụng để xử lý đơn hàng, tăng trải nghiệm sử dụng website, và cho các mục
