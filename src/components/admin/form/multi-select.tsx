...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  return (
    <div className="w-full" ref={dropdownRef}>
      <label id="multiselect-label" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
        {label}
      </label>
            ...
            <div className="mb-2 flex h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300">
              <div className="flex flex-wrap flex-auto gap-2">
                {selectedValuesText.length > 0 ? (
                    ...
                    <div
                      ...
                      onKeyDown={e => {
                        if (e.key === "Enter" || e.key === " ") {
                          removeOption(selectedOptions[index], e as unknown as React.MouseEvent);
                        }
                      }}
                  ...
                  <span className="w-full h-full p-1 pr-2 text-sm text-gray-800 dark:text-white/90">Select option</span>
                )}
              </div>
