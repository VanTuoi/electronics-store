...
import { useCreateSchedules } from "~/hooks";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="request-form bg-primary py-5">
      ...
      <div className="form-group">
        ...
        <input id="phone" type="text" className="form-control" placeholder="0369369369" {...register("phone")} />
      ...
      <div className="form-group">
        ...
        <input id="note" type="text" className="form-control" placeholder="Loại đồ án,..." {...register("note")} />
