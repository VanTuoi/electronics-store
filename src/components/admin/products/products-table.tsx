              ...
              {dataProducts?.map(product => (
                ...
                >
                  <TableCell className="px-5 py-4 text-center items-center text-theme-sm">
                    <img src={getMainImage(product.images || [])} alt={product.name} className="w-12 h-12 rounded-md" />
                  </TableCell>
                  ...
                  <TableCell className="px-5 py-4 text-start text-theme-sm">
                    <TooltipText maxWidth="max-w-xs">{formatCurrency(product.price || 0) || "—"}</TooltipText>
                  </TableCell>
                  <TableCell className="px-5 py-4 text-start text-theme-sm">{product.priceText}</TableCell>
                  <TableCell className="px-5 py-4 text-start text-theme-sm">
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${
                        !product.isHidden
                  ...
                  <TableCell className="px-5 py-4 text-start text-theme-sm">
                    {product?.updatedAt ? format(new Date(product.updatedAt), "HH:mm dd/MM/yyyy") : "—"}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
