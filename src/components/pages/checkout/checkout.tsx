...
import { formatCurrency, getDisplayPrice } from "~/utils";
...
export const Checkout = memo(() => {
  ...
  useEffect(() => {
    setCost(calculateShippingCost(cartState?.reduce((re: number, current: CartItem) => re + current.quantity, 0) ?? 0));
  }, [cartState]);
        ...
        <div className="col-md-12">
          ...
          <div className="mb-5">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-3 text-end fw-bold fs-5 text-danger">{formatCurrency(totalPrice + cost)}</div>
            </div>
          </div>
          <div className="col-md-12">
