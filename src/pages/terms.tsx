    ...
    <div className="bg-light p-4 rounded-3 shadow-sm">
      ...
      <section className="mb-4">
        ...
        <p className="text-muted">
          Bằng việc truy cập và sử dụng website của chúng tôi, bạn đồng ý tuân thủ và chịu ràng buộc bởi các điều khoản
      ...
      <section>
        ...
        <p className="text-muted">
          Chúng tôi có quyền thay đổi các điều khoản này mà không cần thông báo trước. Việc tiếp tục sử dụng website sau
          khi thay đổi đồng nghĩa với việc bạn chấp nhận những thay đổi đó.
        </p>
      </section>
    </div>
  </div>
